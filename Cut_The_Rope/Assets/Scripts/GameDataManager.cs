...
public class AudioSetting
{
    ...
    public void Load()
    {
        ...
        AudioSetting audioSetting = GameDataManager.instance.gameData.optionData.audioSetting;
        audioSetting.masterVolumePercent = loadData.masterVolumePercent;
        audioSetting.musicVolumePercent = loadData.musicVolumePercent;
        audioSetting.sfxVolumePercent = loadData.sfxVolumePercent;
    }
}
